...
export const products: Product[] = [
  ...
  },
  {
    ...
    color: "Yellow",
    sizes: ["M", "L", "XL", "XXL"],
    description: "Bright yellow shorts that'll make every day feel like summer. Warning: may cause excessive happiness! ☀️",
    rating: 4.9,
    reviews: 203,
    badge: "HOT DEAL",
  },
  ...
  },
  {
    ...
    color: "Coral",
    sizes: ["S", "M", "L", "XL"],
    description: "Extra soft coral trunks with a relaxed fit. Your everyday hero underwear! 🦸‍♂️",
    rating: 4.8,
    reviews: 145,
    badge: "POPULAR",
  },
